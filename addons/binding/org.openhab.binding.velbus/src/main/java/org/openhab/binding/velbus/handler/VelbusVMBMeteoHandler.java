...
public class VelbusVMBMeteoHandler extends VelbusTemperatureSensorHandler {
    ...
    public VelbusVMBMeteoHandler(Thing thing) {
        super(thing, 0, new ChannelUID(thing.getUID(), "weaterStation#CH10"));

        this.rainfallChannel = new ChannelUID(thing.getUID(), "weaterStation#CH11");
        this.illuminanceChannel = new ChannelUID(thing.getUID(), "weaterStation#CH12");
        this.windspeedChannel = new ChannelUID(thing.getUID(), "weaterStation#CH13");
    }
